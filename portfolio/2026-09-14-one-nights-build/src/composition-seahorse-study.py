...
c = (-0.7445 + (xs + 0.5 - N / 2) / N * 0.03) + 1j * (0.1215 + (N / 2 - ys - 0.5) / N * 0.03)
...
split(0, 0, N)
img.save(D + 'composition-seahorse-study.png')
img.resize((700, 700)).save(D + 'mondrian2-preview.png')
print('ok')
