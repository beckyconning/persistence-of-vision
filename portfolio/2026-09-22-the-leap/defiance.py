"""No. (study): the Laugh Lines vocabulary made to say defiance. No outline, no hair, no shading.
...
def half(k):
    return [
        ((-4.0, -1.05), (-2.6, -1.55), (-1.3, -1.15), 0.28),    # upper lid, narrowed
        ((-3.7, -0.9), (-2.6, -0.6), (-1.5, -0.95), 0.14),      # lower lid, tensed up
        ((-2.62, -1.12), (-2.5, -1.02), (-2.38, -1.12), 0.26),  # iris, straight at you
        ((-4.4, -2.15), (-2.9, -2.65), (-1.15, -1.75), 0.34),   # brow, pulled down and in
        ((-1.25, -1.9), (-1.05, -2.3), (-0.95, -2.7), 0.10),    # the frown line between them
        ((-0.42, 0.65), (-1.45, 1.35), (-0.62, 2.12), 0.20),    # nose wing
        ((-0.62, 2.12), (-0.45, 2.3), (-0.22, 2.24), 0.10),     # nostril
        ((-1.3, 1.62), (-2.3, 2.9), (-2.0, 3.9), 0.12),         # bracket, faint
    ]

def centre(k):
    return [((-1.5, 3.75), (0.0, 3.55), (1.5, 3.7), 0.26),        # the set mouth
            ((-0.9, 4.3), (0.0, 4.5), (0.9, 4.28), 0.09),         # lower lip pressed
            ((-0.9, 5.6), (0.0, 5.2), (0.9, 5.6), 0.14)]          # chin up, bunched
