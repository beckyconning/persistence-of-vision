...
|---|---|---|---|---|
| 2026-06-30 | [hatched-face](2026-06-30-hatched-face/) | 3 | **method: tone from HATCHING** (discrete directional ink strokes, not a continuous field) + **subject: the FULL-FRONT expressive face** (marquee-open) | A pensive downcast head built only from cross-hatch layers; a trois-crayons sanguine+white-chalk variant on toned paper; and a half-working iso-contour "engraving" (reads as a topo-map — logged). |
