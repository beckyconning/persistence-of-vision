...
|---|---|---|---|---|
| 2026-06-28 | [raymarch-computed-light](2026-06-28-raymarch-computed-light/) | 3 | **light: painted/relief → SIMULATED** (SDF ray-marcher, soft shadows + AO), **off-centre composition** | A numpy ray-marcher: dusk spheres (proof) + a smooth-min fused stone (the picture). |
